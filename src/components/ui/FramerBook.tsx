...
// Inline shim replacing react/jsx-runtime bare specifier (ESM imports are hoisted so React is available)
import * as __ReactShim__ from "react";
const _jsx = (type: any, { children, ...props }: any = {}, key?: any) =>
  __ReactShim__.createElement(type, key != null ? { ...props, key } : props, children);
const _jsxs = (type: any, { children, ...props }: any = {}, key?: any) =>
